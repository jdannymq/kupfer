...
@Name("listadosSolicitudesEstadosDevolucionAction")
@Scope(ScopeType.CONVERSATION)
public class ListadosSolicitudesEstadosDevolucionAction implements Serializable{
		...
		try{
			   ...
			   List<LcredSolicitud> listaSolictudIngresdas = (List<LcredSolicitud>)entityManager
                       .createQuery("Select s from LcredSolicitud s " +
                       		" Where  s.devolver=:devolver" +
                       		" and s.codEmisor=:usuario" +
                       		" order by s.id.numSolicitud desc" )
                       .setParameter("devolver",true)
                       .setParameter("usuario", usuarioSegur.getAlias().toLowerCase())
                       .getResultList();			
	...
	public List<CanalUsuarioCargo> getListaCanalUsuarioCargos() {
		return listaCanalUsuarioCargos;
	}

	public void setListaCanalUsuarioCargos(
			List<CanalUsuarioCargo> listaCanalUsuarioCargos) {
		this.listaCanalUsuarioCargos = listaCanalUsuarioCargos;
	}

	public List<PerfilFuncionCanal> getListaPerfilFuncionCanals() {
		return listaPerfilFuncionCanals;
	}

	public void setListaPerfilFuncionCanals(
			List<PerfilFuncionCanal> listaPerfilFuncionCanals) {
		this.listaPerfilFuncionCanals = listaPerfilFuncionCanals;
	}

	public List<ZonaSucursalNegocioConcepto> getListaZonaSucursalNegocioConceptos() {
		return listaZonaSucursalNegocioConceptos;
	}

	public void setListaZonaSucursalNegocioConceptos(
			List<ZonaSucursalNegocioConcepto> listaZonaSucursalNegocioConceptos) {
		this.listaZonaSucursalNegocioConceptos = listaZonaSucursalNegocioConceptos;
	}
